  ...
  return (
    <main className="home">
      ...
      <section className="home__section home__section--hero">
        <div className="home__hero">
          <div className="home__hero-left">
            <div className="home__hero-products">
              <img src="images/main_1.png" alt="rejuran products" />
            </div>
          ...
          <div className="home__hero-right">
            <img src="images/main_2.png" alt="face" />
          </div>
        </div>
      </section>
      ...
      <section className="home__section home__section--bestsellers">
        ...
        <ul className="home__products">КАРТОЧКИ</ul>
      </section>
      ...
      <section className="home__section home__section--new">
        ...
        <ul className="home__products">ТУТ КАРТКИ </ul>
      </section>
      ...
      <section className="home__section home__section--sale">
        <div className="home__sale">
          <img
            className="home__sale-image"
            src="images/main_sale.png"
            alt="sale"
          />
      ...
      <section className="home__section home__section--promotions">
        ...
        <ul className="home__products">ТУТ КАРТОЧКИ</ul>
      </section>
      ...
      <section className="home__section home__section--blog">
        ...
        <ul className="home__articles">ТУТ КАРТОЧКИ</ul>
      </section>
    </main>
  );
}
